...
export default function GenericTab({ tab, overrides, onChange, searchQuery = '', onBulkApply }: GenericTabProps) {
  ...
  return <FlatTab tab={tab} getValue={getValue} setValue={setValue} deleteValue={deleteValue}
    overrides={overrides} contributions={[PREVIEW_GLYPH]} searchQuery={searchQuery} onBulkApply={onBulkApply}
