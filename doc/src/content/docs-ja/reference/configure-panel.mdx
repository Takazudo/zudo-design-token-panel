...
> `configurePanel` 全体のリファレンスは現在 [英語版](/docs/reference/configure-panel)を参照してください。このページでは `domTweaker` の設定を日本語で説明します。
...
操作方法、`themeCss` の役割、対応範囲については [DOM Tweaker](/ja/docs/reference/dom-tweaker)を参照してください。
