...
[Color cluster reference](../reference/color-cluster.mdx) section on
`colorPresets`.
...
- [Color cluster reference](../reference/color-cluster.mdx) — full
  cluster shape, `colorSchemes` registry, and the preset merge order.
- [Custom color cluster](./custom-color-cluster.mdx) — wiring
