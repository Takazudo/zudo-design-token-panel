...
<Note>
See [Apply pipeline setup](/docs/recipes/apply-pipeline-setup) for the routing-JSON recipe that wires a Tailwind v4 host's `@theme` file into `applyRouting`.
</Note>
