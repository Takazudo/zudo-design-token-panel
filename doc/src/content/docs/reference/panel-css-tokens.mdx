...
| --- | --- | --- |
| `--tokentweak-color-fg` | `oklch(0.8 0 0)` | Foreground text. |
| `--tokentweak-color-bg` | `oklch(0.18 0 0)` | Recessed wells and inverse ink on accent fills. |
| `--tokentweak-color-muted` | `oklch(0.66 0 0)` | Muted and secondary text. |
| `--tokentweak-color-border` | `oklch(0.536 0 0)` | Borders and dividers. |
| `--tokentweak-color-surface` | `oklch(0.25 0 0)` | Panel shell and raised surfaces (cards, modals). |
...
| `--tokentweak-color-code-bg` | `oklch(0.34 0 0)` | Inline / block code background. |
| `--tokentweak-color-code-fg` | `oklch(0.91 0 0)` | Inline / block code foreground. |
