...
This page is the type-by-type pin-down of the tier model. If you want to understand the design rationale and the literal / reference tier relationship first, read [The abstract token-tier model](/docs/architecture#the-abstract-token-tier-model).
</Info>
