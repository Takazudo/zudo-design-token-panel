...
You're installed. Head to [Quickstart](./quickstart) for the smallest end-to-end wiring, or to [Frameworks Comparison](./frameworks-comparison) for a side-by-side comparison of Astro / Vite + React / Next.js setups.
