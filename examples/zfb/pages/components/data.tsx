 ...
 * Tailwind utilities replaced by .zfbexample-table*, .zfbexample-media-card*,
 * .zfbexample-stat-card*, .zfbexample-profile-card*, .zfbexample-avatar-row*
...
export default function DataPage() {
  return (
    ...
    >
      <div class="zfbexample-page-stack" style={{ gap: 'var(--zfbexample-vsp-xl)' }}>

        {/* ── Page header ─────────────────────────────────────────────────── */}
        <div>
          <h1 class="zfbexample-section-h2">Data &amp; media demo</h1>
        ...
        {/* ── 1. Data table ───────────────────────────────────────────────── */}
        <section class="zfbexample-field-group" style={{ gap: 'var(--zfbexample-vsp-sm)' }}>
          <h2 class="zfbexample-section-h3">Data table with row actions</h2>
        ...
        {/* ── 2. Media card ───────────────────────────────────────────────── */}
        <section class="zfbexample-field-group" style={{ gap: 'var(--zfbexample-vsp-sm)' }}>
          <h2 class="zfbexample-section-h3">Media card</h2>
          <p class="zfbexample-muted-text">
        ...
        {/* ── 3. Stat cards ───────────────────────────────────────────────── */}
        <section class="zfbexample-field-group" style={{ gap: 'var(--zfbexample-vsp-sm)' }}>
          <h2 class="zfbexample-section-h3">Stat cards</h2>
          <p class="zfbexample-muted-text">
          ...
          <div class="zfbexample-flex-wrap-md">
        ...
        {/* ── 4. Profile card ─────────────────────────────────────────────── */}
        <section class="zfbexample-field-group" style={{ gap: 'var(--zfbexample-vsp-sm)' }}>
          <h2 class="zfbexample-section-h3">Profile card</h2>
          <p class="zfbexample-muted-text">
          ...
          <div class="zfbexample-field-group" style={{ maxWidth: '32rem' }}>
        ...
        {/* ── 5. Avatar row ───────────────────────────────────────────────── */}
        <section class="zfbexample-field-group" style={{ gap: 'var(--zfbexample-vsp-sm)' }}>
          <h2 class="zfbexample-section-h3">Avatar row</h2>
          <p class="zfbexample-muted-text">
