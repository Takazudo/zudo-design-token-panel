 ...
 * Deploy paths
 * ------------
 * The example is hosted at `https://takazudomodular.com/pj/zudo-design-token-panel/examples/next/`, so
 * `basePath` and `assetPrefix` are both pinned to `/pj/zudo-design-token-panel/examples/next`. Next
...
const nextConfig: NextConfig = {
  ...
  basePath: '/pj/zudo-design-token-panel/examples/next',
  assetPrefix: '/pj/zudo-design-token-panel/examples/next',
  trailingSlash: true,
